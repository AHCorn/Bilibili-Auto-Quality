...
为避免兼容性问题，脚本目前不再默认开启解锁相关功能，您可以在解锁设置面板中自行打开。

因为没有特别关注解锁方面的可用性，所以您也可以直接使用下方脚本，本脚本的解锁相关代码来自于此，但同步可能不够及时。
...
解锁相关代码来自 [Bilibili 解锁杜比全景声 & 8K &开启 HDR &直播画质PRO](https://greasyfork.org/zh-TW/scripts/441403)
